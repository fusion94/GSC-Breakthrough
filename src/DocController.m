...
// set the default map lists for available maplist AND maprotationlist
{
    ...
    switch ([[gameType selectedItem] tag]) {
        ...
        case 2:
        case 3:
            [aMapArray addObject:@"obj/mp_palermo_obj"];
            [aMapArray addObject:@"obj/mp_montebattaglia_tow"];
            [aMapArray addObject:@"lib/mp_anzio_lib"];
            [aMapArray addObject:@"lib/mp_tunisia_lib"];
            [aMapArray addObject:@"obj/mp_castello_obj"];
            [aMapArray addObject:@"lib/mp_bizerteharbor_lib"];
            [aMapArray addObject:@"obj/mp_montecassino_tow"];
            [aMapArray addObject:@"obj/mp_bologna_obj"];
            [aMapArray addObject:@"obj/mp_kasserine_tow"];
            [aMapArray addObject:@"obj/mp_bizertefort_obj"];
            [aMapArray addObject:@"lib/mp_ship_lib"];
        ...
        case 4:
            ...
            [aMapArray addObject:@"obj/mp_palermo_obj"];
            [aMapArray addObject:@"obj/mp_bizertefort_obj"];
            [aMapArray addObject:@"obj/mp_ship_lib"];
        ...
        case 5:
            ...
            [aMapArray addObject:@"obj/mp_kasserine_tow"];
            [aMapArray addObject:@"obj/mp_montebattaglia_tow"];
            [aMapArray addObject:@"obj/mp_druckkammern_tow"];
            [aMapArray addObject:@"obj/mp_flughafen_tow"];
            [aMapArray addObject:@"obj/mp_ardennes_tow"];
            [aMapArray addObject:@"obj/mp_berlin_tow"];
            break;
        case 6:
            [aMapArray addObject:@"lib/mp_anzio_lib"];
            [aMapArray addObject:@"lib/mp_bizerteharbor_lib"];
...
- (void)netWorkDefaults
{
    ...
    [setRconPass setStringValue:@"PleaseUseMoreThan6Characters"];
...
// gets the map names from the game folder
{
	...
	NSArray * searchDirs = [BASEDIRNAMES componentsSeparatedByString:@","]; // get maps directories
	
	NSEnumerator * f = [searchDirs objectEnumerator]; // traverse the dirs
	id curdir;
	while (curdir = [f nextObject]) { // start traversing the file list
		NSString * mapDirName = curdir; // get the mapdirname
		//NSLog (@"dir: %@", mapDirName);
