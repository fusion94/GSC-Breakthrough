// messages
#define CONSOLEGREETING		@"Game Server Configulator (Breakthrough) greets those who are playing Medal of Honor!"
#define CONSOLE_HEADER		@"MoH:Breakthrough server run by Game Server Configulator - Breakthrough.\n©2003-2006 P-Edge media - www.p-edge.nl\n\nThe \"Mohaab server executable\" is copyrighted by Aspyr Media inc.\n"
#define CONFIG_HEADER1		@"// Created by Game Server Configulator -Breakthrough-]\n// (C) 2003-2006 P-Edge media - www.p-edge.nl\n"
#define CONFIG_HEADER2          @"// For more info visit www.p-edge.nl/gsc\n\n"
#define SERVMESSGREETING	@"*** this server is run by GSC for Mac OSX! (www.p-edge.nl/gsc) ***"

// about window
#define ABO_VERS		@"version "
#define GSC_TITLE		@"Game Server Configulator\n(MoH: Breakthrough)"
#define COPYRIGHT_TEXT		@"Copyright ©2003-2006 P-Edge media."
#define ABOUT_DISCLAIM          @"The \"mohaab_server\" executable is copyrighted by Aspyr Media inc. and EA Games."
...
#define PRF_GAMEFOLDER2		@"mohaab_server is not here:"
#define PRF_YOUNEEDEXE1         @"Dedicated server executable missing"
#define PRF_YOUNEEDEXE2         @"The dedicated server executable \"mohaab_server\" is not in the selected game folder."
...
#define ALE_NOTEXECUTABLE1	@"mohaab_server is not executable"
...
#define ALE_NOTEXEC_FIXED4      @"Your mohaab_server is now executable."
